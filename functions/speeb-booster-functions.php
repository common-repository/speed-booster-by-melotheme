...
//HTML Page Minifier
if( get_option("SPEEDBOOSTER_check_enable")  == 1 ) {

if ( get_option("SPEEDBOOSTER_check_enable")  == 1 && get_option("SPEEDBOOSTER_adv_enable") == 0 ) {
	update_option("SPEEDBOOSTER_html_enable","1");
	update_option("SPEEDBOOSTER_comm_enable","1");
	update_option("SPEEDBOOSTER_emoj_enable","1");
	update_option("SPEEDBOOSTER_migr_enable","1");
	update_option("SPEEDBOOSTER_shor_enable","1");
	update_option("SPEEDBOOSTER_quer_enable","1");
	update_option("SPEEDBOOSTER_foot_enable","0");
	update_option("SPEEDBOOSTER_async_enable","1");
	update_option("SPEEDBOOSTER_lazy_enable","1");
	update_option("SPEEDBOOSTER_cach_enable","1");
	update_option("SPEEDBOOSTER_embd_enable","1");	
	update_option("SPEEDBOOSTER_admn_enable","1");	
}
	
	
if( get_option("SPEEDBOOSTER_html_enable")  == 1 ) {
...
if( get_option("SPEEDBOOSTER_comm_enable")  == 1 ) {
...
if( get_option("SPEEDBOOSTER_emoj_enable")  == 1 ) {
//Disable Emojis
...
if( get_option("SPEEDBOOSTER_migr_enable")  == 1 ) {
//Remove JS Migrate
...
if( get_option("SPEEDBOOSTER_shor_enable")  == 1 ) {
//Remove Shortlinks
	remove_action('wp_head', 'wp_shortlink_wp_head', 10, 0);
}

if( get_option("SPEEDBOOSTER_quer_enable")  == 1 ) {
...
if( get_option("SPEEDBOOSTER_foot_enable")  == 1 ) {
//Scripts to Footer
...
if( get_option("SPEEDBOOSTER_async_enable")  == 1 ) {
//ASYNC Tag
...
if( get_option("SPEEDBOOSTER_lazy_enable")  == 1 ) {
//Lazy Images
...
function jsClear() {
    wp_enqueue_script( 'speebbooster-lazy-load', SPEEDBOOSTER_URL.'admin/assets/js/lazy-load.js', array(), '1.0.0', true );
}
...
if( get_option("SPEEDBOOSTER_cach_enable")  == 1 ) {
//Browser Caching
function lavaCach() {
...
if( get_option("SPEEDBOOSTER_embd_enable")  == 1 ) {
//WP Embed
...
if( get_option("SPEEDBOOSTER_admn_enable")  == 1 ) {
